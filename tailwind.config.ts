  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-in-left": { "0%": { opacity: "0", transform: "translateX(-60px)" }, "100%": { opacity: "1", transform: "translateX(0)" } },
        glow: {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--primary) / 0.4)" },
          "50%": { boxShadow: "0 0 50px hsl(var(--primary) / 0.7)" },
        },
        float: {
      ...
      animation: {
        ...
        "slide-in-right": "slide-in-right 0.7s var(--transition-smooth) both",
        "slide-in-left": "slide-in-left 0.7s var(--transition-smooth) both",
